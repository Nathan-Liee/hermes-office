...
const DEFAULT_UPSTREAM_GATEWAY_URL =
  process.env.NEXT_PUBLIC_GATEWAY_URL || "http://localhost:20128/v1";
...
const normalizeGatewayProfilesPublic = (
  ...
  for (const adapterType of ["openclaw", "hermes", "demo", "local", "ho3d", "custom"] as const) {
