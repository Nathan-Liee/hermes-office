...
metadata: {"ho3d":{"skillKey":"todo-board"}}
---
...
metadata: {"ho3d":{"skillKey":"task-manager"}}
---
...
- \`\${HO3D_STATE_DIR}/ho3d/task-manager/tasks.json\` when \`HO3D_STATE_DIR\` is set.
- \`~/.ho3d/ho3d/task-manager/tasks.json\` otherwise.
...
metadata: {"ho3d":{"skillKey":"soundclaw"}}
---
...
## HO3D Gateway Skill Contract

> This section is for developers implementing the backend skill handler in HO3D.
> The HO3D UI handles authentication via Spotify PKCE OAuth in the browser.
